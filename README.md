# AbsaUGDTMicrosrvcNotificationSvc
...
To build the final jar and optimize the AbsaUGDTMicrosrvcNotificationSvc application for production, run:
...
Then navigate to [http://localhost:9060](http://localhost:9060) in your browser.
